...
function leadDelete(ele){
         
    swal({
        title: "Are you sure?",
        text: 'yes, continue it for delete Client',
        type: "info",
      ...
      function(isConfirm){
        ...
        if (isConfirm) {
          ...
          swal("Cancelled", "Client not Deleted", "error");
        }
    });
...
function show_select_departments(route_url){
    $.ajax({
...
function add_email_modal_method(ele){

    $.ajax({

     type: "get",

     url : main_url+'/leads/add_email/'+ele,
...
function add_emp_modal_method(ele){

        $.ajax({

         type: "get",
    
         url : main_url+'/leads/add_employee/'+ele,
...
function edit_emp_modal_method(ele){
    ...
    $.ajax({
        ...
        url : main_url+'/leads/edit_employee/'+ele,
...
function add_doc_modal_method(ele){
    ...
    $.ajax({
        ...
        url : main_url+'/leads/add_dco/'+ele,
