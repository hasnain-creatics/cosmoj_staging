...
<div class="modal fade" id="order_message_modal">
			<div class="modal-dialog  modal-lg" role="document">
				<div class="modal-content">
                	<div class="modal-header message-model-custom">
						<h6 class="modal-title">Message / ORDER-{{$id}}</h6>
					</div>
    ...
    <script>
        function modal_messages(ele,reload =null) {
        ...
        $(document).ready(function() {
            ...
            //         console.log('here getting new notiffications' );
            //         modal_messages(ele);
