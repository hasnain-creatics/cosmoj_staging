    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Employeer Details
                        ...
                        <div class="card">
									<div class="card-body">
										<ul class="list-group m-2">
											...
											<li class="list-group-item">{{$result->companysname}}</li>
											<li class="list-group-item">The Client’s Current Plan</li>
											<li class="list-group-item">{{$result->selectan}}</li>
											<li class="list-group-item">Client’s Email</li>
                                            <li class="list-group-item">{{$result->companyscorporate31}}</li>
                                            <li class="list-group-item">Client’s Phone Number</li>
                                            <li class="list-group-item">{{$companyscorporate36[0]}}</li>
										</ul>
									</div>
						        </div>
                        <button class="btn btn-danger pull-right "  onClick="add_email_modal_method({{$result->id}})">
                        ...
                        <div class="col-md-12 col-lg-12">
								<div class="card overflow-hidden">
									<div class="card-header bg-primary ">
										<h3 class="card-title text-white">Employees List</h3>
