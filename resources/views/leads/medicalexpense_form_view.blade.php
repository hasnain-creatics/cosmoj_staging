    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Medicalexpense Client's Details
                        ...
                        <div class="card">
									<div class="card-body">
										<ul class="list-group m-2">
											...
											<li class="list-group-item">Payment Plan Duration</li>
											<li class="list-group-item"> {{$result->paymentplan}} </li>
                                            ...
                                            <li class="list-group-item">{{$phoneNumber[0]."-".$phoneNumber[1]."-".$phoneNumber[2]}}</li>
                                            <li class="list-group-item">Staff Code</li>
                                            <li class="list-group-item">{{$result->staffcode}}</li>
                                        </ul>
									</div>
						        </div>
                        </div>
