...
<div class="app-content main-content">
			...
			<div class="container-fluid">
				<div class="d-flex">
					...
					<a class="header-brand" href="index.html">
						<img src="{{url('public')}}/assets/images/cosmojlogo.png" class="header-brand-img desktop-lgo" alt="Cosmoj's logo">
						<img src="{{url('public')}}/lassets/images/cosmojlogo.png" class="header-brand-img dark-logo" alt="Cosmoj's logo">
						<img src="{{url('public')}}/assets/images/cosmojlogo.png" class="header-brand-img mobile-logo" alt="Cosmoj's logo">
						<img src="{{url('public')}}/assets/images/cosmojlogo.png" class="header-brand-img darkmobile-logo" alt="Cosmoj's logo">
					</a>
						...
						<div class="navbar navbar-expand-lg navbar-collapse responsive-navbar p-0">
							<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
								<div class="d-flex order-lg-2">
									...
									<!-- <div class="dropdown notification-dropdown header-notify d-flex">
										...
										<a href="javascript:void(0);" class="nav-link pe-0 leading-none" data-bs-toggle="dropdown">
											<span class="header-avatar1">
												...
												<img src="{{url('storage/app')}}/{{Auth::user()->profile_image_id}}" alt="img" class="avatar avatar-md brround">
													@else
													<img src="{{asset('public/assets/images/no_image.jpg')}}" alt="img" class="avatar avatar-md brround">
												@endif
											</span>
										</a>
	...
	<div class="position-fixed toaster-custom-mesg end-0 p-3" style="z-index: 11">
...
<script type="text/javascript">
	...
	$(document).on('click', '.notification-dropdown', function() {
		...
		$('.notification_drop_down_div').toggle('d-block');

	});

	$(document).on('click', function() {

		if ($('.notification-dropdown .notification_drop_down_div').hasClass('d-block')) {

			$('.notification_drop_down_div').removeClass('d-block')
