							...
							<div class="container-fluid">
								...
								<div class="d-flex">
									...
									<a class="header-brand" href="index.html">
										...
										<img src="{{asset('public')}}/assets/images/cosmojlogo.png" class="header-brand-img desktop-lgo" alt="Azea logo">

										<img src="{{asset('public')}}/assets/images/cosmojlogo.png" class="header-brand-img dark-logo" alt="Azea logo">

										<img src="{{asset('public')}}/assets/images/cosmojlogo.png" class="header-brand-img mobile-logo" alt="Azea logo">

										<img src="{{asset('public')}}/assets/images/cosmojlogo.png" class="header-brand-img darkmobile-logo" alt="Azea logo">
													...
													<!--	<div class="dropdown country-selector d-flex">
														...
														<a href="javascript:void(0);" class="nav-link leading-none" data-bs-toggle="dropdown">
															...
															<span class="header-avatar1">
																...
																<img src="{{asset('public')}}/assets/images/us_flag.jpg" alt="img" class="me-2 country">
														...
														<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow animated">
															...
															<a class="dropdown-item d-flex" href="profile-1.html">
																...
																<img src="{{asset('public')}}/assets/images/germany_flag.jpg" alt="img" class="me-2 country mt-1">
															...
															<a class="dropdown-item d-flex" href="search.html">
																...
																<img src="{{asset('public')}}/assets/images/italy_flag.jpg" alt="img" class="me-2 country mt-1">
															...
															<a class="dropdown-item d-flex" href="chat.html">
																...
																<img src="{{asset('public')}}/assets/images/russia_flag.jpg" alt="img" class="me-2 country mt-1">
															...
															<a class="dropdown-item d-flex" href="login-1.html">
																...
																<img src="{{asset('public')}}/assets/images/spain_flag.jpg" alt="img" class=" me-2 country mt-1">
													...
													<div class="dropdown profile-dropdown d-flex">
														...
														<a href="javascript:void(0);" class="nav-link pe-0 leading-none" data-bs-toggle="dropdown">
															...
															<span class="header-avatar1">
																...
																<img src="{{asset('public')}}/assets/images/users/2.jpg" alt="img" class="avatar avatar-md brround">
