    ...
    <table class="table table-bordered text-nowrap dataTable no-footer" id="example1" role="grid"
      ...
      <thead>
        <tr role="row">
          ...
          <th class="wd-15p border-bottom-0" tabindex="0">Medical Facility's Name</th>
      ...
      $(document).ready(function () {
        ...
        $("#example1").DataTable({
          ...
          columns: [
            ...
            { data: "medicalfacilitys", name: "medicalfacilitys" },
            { data: "medicalfacilitys31", name: "medicalfacilitys31" },
            { data: "medicalfacilitys36", name: "medicalfacilitys36" },
            { data: "medicalfacilitys39", name: "medicalfacilitys39" },
            { data: "madical_provider_city", name: "madical_provider_city" },
