<template>
  ...
  <div class="col-md-12">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="input-group mb-4">
          <input type="text" v-model="filter.email_ind" class="form-control input-text" name="email_ind" placeholder="Email"
            aria-describedby="basic-addon2" id="filter_email_ind" />
        </div>
      </div>
      <div class="col-md-4">
          <div class="input-group mb-4">
    ...
    <table class="table table-bordered text-nowrap dataTable no-footer" id="example1" role="grid"
      ...
      <thead>
        <tr role="row">
          ...
          <th class="wd-15p border-bottom-0" tabindex="0">Date Of Birth</th>
...
export default {
  ...
  methods: {
    ...
    filter_button() {
      ...
      filter_array.email_ind = "";
      if (this.filter.email_ind) {
        filter_array.email_ind = this.filter.email_ind;
      }
      filter_array.status = "";
      ...
      $(document).ready(function () {
        ...
        $("#example1").DataTable({
          ...
          columns: [
            ...
            { data: "city_inv", name: "city_inv" },
            { data: "dateOf", name: "dateOf" },
