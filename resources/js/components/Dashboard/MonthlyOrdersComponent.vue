<template>
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header bg-secondary monthly-table-card monthly-order">
        <h3 class="card-title text-white">Monthly Orders</h3>
...
export default {
  data() {
    return {
      ...
      result: [],
      page_links: "",
      url: this.$hostname + "dashboard/monthly_orders?page=1",
      current_page : 1,
      total_record: 0,
    };
  },
