<template>
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header bg-secondary qa-table-card qa-approveds">
        <h3 class="card-title text-white"> QA Approved Orders</h3>
...
export default {
  data() {
    return {
      ...
      result: [],
      page_links: "",
      url: this.$hostname + "dashboard/sale_qa_approved_orders?page=1",
      current_page : 1,
      total_record: 0,
    };
  },
