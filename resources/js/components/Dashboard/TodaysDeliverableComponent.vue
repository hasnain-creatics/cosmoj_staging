<template>
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header bg-secondary today-table-card today-delivery">
        <h3 class="card-title text-white">Today's Deliverables</h3>
...
export default {
  data() {
    return {
      ...
      result: [],
      page_links: "",
      url: this.$hostname + "dashboard/today_deliverable?page=1",
      current_page : 1,
      total_record: 0,
    };
  },
