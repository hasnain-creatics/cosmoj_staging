<template>
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header bg-secondary task-table-card task-urgent">
        <h3 class="card-title text-white">Urgent Tasks</h3>
...
export default {
  data() {
    return {
      ...
      result: [],
      page_links: "",
      url: this.$hostname + "dashboard/writer_urgent_tasks?page=1",
      current_page : 1,
      total_record: 0,
    };
  },
