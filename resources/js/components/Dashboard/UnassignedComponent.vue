<template>
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header bg-warning task-table-card task-unassigned">
        <h3 class="card-title text-white">Unassigned</h3>
...
export default {
  data() {
    return {
      ...
      result: [],
      page_links: "",
      url: this.$hostname + "dashboard/unassigned_task?page=1",
      current_page : 1,
      total_record: 0,
    };
  },
